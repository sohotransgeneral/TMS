      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-lg border bg-card p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="text-muted-foreground">
              {[load.pickupCity, load.pickupCountry].filter(Boolean).join(", ") || "—"}
            </div>
            <div className="mt-1 font-medium">{formatDate(load.pickupDate, true)}</div>
        ...
        <section className="rounded-lg border bg-card p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="text-muted-foreground">
              {[load.deliveryCity, load.deliveryCountry].filter(Boolean).join(", ") || "—"}
            </div>
            <div className="mt-1 font-medium">{formatDate(load.deliveryDate, true)}</div>
        ...
        <section className="rounded-lg border bg-card p-6">
          ...
          <dl className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <dd>{load.weightKg ? `${load.weightKg.toLocaleString()} lbs` : "—"}</dd>
            </div>
            <div>
        ...
        <dl className="grid grid-cols-2 gap-3 text-sm sm:grid-cols-4">
          ...
          <div>
            ...
            <dd>
              ...
              {load.truck?.make && (
                <div className="text-xs text-muted-foreground">
                  {[load.truck.make, load.truck.model].filter(Boolean).join(" ")}
                </div>
              )}
            </dd>
          </div>
          ...
          <div className="flex flex-wrap gap-6 text-sm">
            ...
            {load.brokerEmail && (
              <div className="flex items-center gap-2">
                ...
                <a href={`mailto:${load.brokerEmail}`} className="hover:underline">
                  {load.brokerEmail}
                </a>
              </div>
            )}
