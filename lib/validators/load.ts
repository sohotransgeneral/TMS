...
export const loadCreateSchema = z.object({
  ...
  deliveryTimezone: optionalString,
  ...
  accessorials: optionalString,
  loadNumber: optionalString,
  pickupNumber: optionalString,
  deliveryNumber: optionalString,
  enteredBy: optionalString,
  invoicingCompany: optionalString,
  billingMethod: optionalString,
  billingType: optionalString,
  loadInvoiceNumber: optionalString,
  accessorialAmount: optionalNumber,
